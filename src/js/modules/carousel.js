define("carousel", ["logger", "jquery"],
  ...
  var initCarousel = function (carouselElement) {
    ...
    // get elements directly below ".nylui-carousel-inner"
    /**
     * The inner div.
     */
    var innerDiv = carouselElement.find(".nylui-carousel-inner");
     ...
     */
    var indicatorWrapper = carouselElement.find(".nylui-carousel-indicators");
...
//    });
    ...
    var wrapperHeight = (parseInt(slides.find(".nylui-card-image img").prop("height"), 10) + 22);
    innerDiv.css({
      "height":  wrapperHeight + "px",
      "width":  parseInt(slides.find(".nylui-card-image img").prop("width"), 10) + "px"
    });
...
//  });
     ...
     * The indicators.
     */
    var indicators = carouselElement.find(".nylui-carousel-indicators ol li");
    indicators.on("click", function () {
      /**
       * The index.
       */
      var index = parseInt($(this).attr("data-slide-to"), 10) - 1;
      seekTo($(".nylui-carousel"), index);
    });
    /**
     * The prev btn.
     */
    var prevBtn = carouselElement.find(".nylui-prev");
     ...
     * The next btn.
     */
    var nextBtn = carouselElement.find(".nylui-next");
    nextBtn.attr("href", "javascript:void(0)");
    nextBtn.on("click", function () {
      next(carouselElement);
    });
    seekTo($(".nylui-carousel"), 0);
  };
  /**
   * @param carouselElement
   */
  ...
  var exports = {
      ...
      initializeDom: function () {
        if ($(".nylui-carousel").length > 0) {
          logger.enable(true);
          logger.report("found carousel");
          /**
           * The carousels.
           */
          var carousels = $(".nylui-carousel");
          /**
           * @type {Number}
           */
